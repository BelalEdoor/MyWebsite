  ...
  return (
    <section id="contact" className="mt-40">
      ...
      <div className="contacts flex items-center justify-center gap-8 mt-6 flex-wrap md:flex-nowrap">
        ...
        <div
          className="
            flex items-center justify-center w-full md:w-1/2 max-w-[30rem] gap-8 rounded-[1.4rem] px-7 py-6 cursor-pointer
        ...
        >
          ...
          <a
            ...
            className="text-gray-900 dark:text-white font-medium hover:text-purple-500 dark:hover:text-purple-300 transition-colors duration-200"
          >
