  ...
  return (
    <section id="contact" className="mt-40">
      ...
      <div className="contacts flex items-center justify-center gap-8 mt-6 flex-wrap md:flex-nowrap">
        {/* Email Box */}
        <div className="flex items-center justify-center w-full md:w-1/2 max-w-[30rem] gap-8 bg-green-500 rounded-[1.4rem] px-7 py-6 transition-colors duration-200 hover:bg-pink-500">
          <a
